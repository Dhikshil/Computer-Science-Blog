        ...
        <nav className="bg-gradient-to-r from-gray-900 via-blue-900 to-gray-900 border-b border-cyan-500/30">
            <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-16 ">
                <div className="flex gap-8">
                    <div class="w-8 h-8 bg-gradient-to-br from-cyan-400 to-blue-600 rounded-lg flex items-center justify-center shadow-lg shadow-cyan-500/25 mt-1"><Link class="text-gray-900 font-black text-sm" to={''}>CS</Link></div>
