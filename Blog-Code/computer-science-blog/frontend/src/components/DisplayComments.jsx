...
export default function DisplayComment({ article, newComment, setNewComment }) {
  useEffect(() => {
    if (newComment === true) {
      setNewComment(false);
    }
  ...
  return (
    <>
      {article.comments.map((comment) => {
        ...
        return (
          <div
            className="w-4/5 mx-auto rounded-xl py-3 bg-white/20 mb-2"
            key={article.comments.indexOf(comment)}
          >
            <div className="mx-3">
